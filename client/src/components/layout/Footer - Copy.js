      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/capabilities" className="text-gray-400 hover:text-white transition-colors">
                  Capabilities
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+16015550199" className="text-gray-400 hover:text-white transition-colors">
                  (601) 555-0199
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="mr-3 text-blue-400 flex-shrink-0" size={18} />
                <a href="mailto:info@reticuli-tech.com" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex items-center">
            ...
            <span className="text-gray-400 text-sm">Securing the future through innovation</span>
          </div>
        </div>
      </div>
    </footer>
