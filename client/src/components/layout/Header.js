...
const Header = ({ scrolled }) => {
  ...
  const navLinks = [
   ...
   // { name: 'Capabilities', path: '/capabilities' },
    ...
    { name: 'Investment Info', path: '/investors' },
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-24 relative">
          ...
          {/* Logo - Increased size from h-12 to h-16 for desktop and mobile */}
          <Link to="/" className="flex items-center group relative">
            ...
            {/* Logo with silver/gray effect - Increased size */}
            <div className="relative">
              <img 
                src="/images/icon.png" 
                alt="Reticuli Technologies" 
                className="h-14 md:h-14 filter brightness-125 contrast-125"
              />
              <motion.div 
