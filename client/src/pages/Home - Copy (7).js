    ...
    <>
        ...
        {!loaded && (
          ...
          >
            <motion.div 
              ...
              className="mb-6"
            >
              <div className="text-4xl text-gray-400 font-bold flex items-center space-x-2">
                <img 
                  src="/images/icon.png" 
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div
            className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-400/5 to-transparent h-32 w-full"
        ...
        <div className="container mx-auto px-4 z-20 relative py-24">
          ...
          >
            <motion.div 
              ...
              className="inline-block mb-8 p-1 border border-gray-700/30 rounded-full"
            >
              <div className="text-xs uppercase tracking-widest text-gray-400 bg-black/80 px-4 py-1 rounded-full">
            ...
            <motion.h1 
              variants={itemVariants}
              className="text-5xl md:text-7xl font-bold text-gray-100 leading-tight mb-6 glitch-text"
            >
              <span className="relative inline-block">
                <span className="relative">
                 
                  <span className="absolute -inset-1 bg-gray-400/10 blur-sm -z-10"></span>
                </span>
              </span>
            </motion.h1>
            ...
            >
              <Link 
                to="/projects"
                className="px-8 py-4 bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-600 hover:to-gray-800 text-white font-bold rounded-md flex items-center justify-center shadow-lg shadow-black/30 border border-gray-600/20 group transition-all duration-300"
              >
                <span className="mr-2">
                  <Code size={18} className="text-gray-300 group-hover:text-white transition-colors duration-300" />
                </span>
                Our Solutions
              </Link>
              <Link 
                to="/contact" 
                className="px-8 py-4 bg-transparent border border-gray-700/30 hover:border-gray-500/60 hover:bg-gray-900/20 text-gray-300 hover:text-gray-100 font-medium rounded-md transition-all duration-300 flex items-center group"
              >
                Request Demo 
        ...
        {/* Tech elements */}
        <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-gray-900/10 to-transparent"></div>
        <div className="absolute bottom-10 left-10">
          ...
          >
            {[...Array(4)].map((_, i) => (
              <div 
                key={i} 
                className="w-2 h-2 rounded-full bg-gray-500 opacity-75"
              >
                <motion.div 
      ...
      <section className="py-20 bg-gray-950 relative overflow-hidden">
        ...
        <motion.div 
          ...
          style={{
            background: "radial-gradient(circle, rgba(75,85,99,0.08) 0%, rgba(0,0,0,0) 70%)",
          }}
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.6, 0.8, 0.6],
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <motion.div
                ...
                className="mb-4"
              >
                <div className="inline-block p-px bg-gradient-to-r from-gray-700/40 via-gray-400/40 to-gray-700/40 rounded-md">
                  <div className="px-4 py-1 bg-gray-900 rounded-md text-sm text-gray-400 uppercase tracking-wider">
              ...
              <motion.h2 
                className="text-3xl md:text-5xl font-bold text-gray-100 mb-6 relative inline-block"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
              >
                Our <span className="text-gray-400">Focus Areas</span>
                <motion.span 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-gray-100 mb-6 relative inline-block">
                <span className="text-gray-400">OSINT</span> Threat Intelligence
                <span className="absolute -bottom-2 left-0 w-3/4 h-px bg-gradient-to-r from-gray-500/50 to-transparent"></span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <motion.div 
                  className="border border-gray-700/20 bg-gray-900/50 p-5 rounded-lg group hover:bg-gray-900/80 transition-all duration-300"
                  whileHover={{ 
                    scale: 1.02,
                    boxShadow: "0 0 20px 0 rgba(75,85,99,0.1)"
                  }}
                >
                  <div className="text-gray-300 text-2xl font-bold mb-1">Multi-source</div>
                  <div className="text-gray-500 text-sm">Intelligence gathering</div>
                  <motion.div 
                    className="absolute inset-0 border border-gray-400/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                    animate={{ 
                      boxShadow: ["0 0 0px 0px rgba(75,85,99,0)", "0 0 10px 1px rgba(75,85,99,0.2)", "0 0 0px 0px rgba(75,85,99,0)"]
                    }}
                ...
                >
                  <div className="text-gray-300 text-2xl font-bold mb-1">Automated</div>
                  <div className="text-gray-500 text-sm">Analysis & reporting</div>
                  <motion.div 
                    className="absolute inset-0 border border-gray-400/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                    animate={{ 
                      boxShadow: ["0 0 0px 0px rgba(75,85,99,0)", "0 0 10px 1px rgba(75,85,99,0.2)", "0 0 0px 0px rgba(75,85,99,0)"]
                ...
                >
                  <div className="text-gray-300 text-2xl font-bold mb-1">Custom</div>
                  <div className="text-gray-500 text-sm">OSINT integrations</div>
                  <motion.div 
                    className="absolute inset-0 border border-gray-400/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                    animate={{ 
                      boxShadow: ["0 0 0px 0px rgba(75,85,99,0)", "0 0 10px 1px rgba(75,85,99,0.2)", "0 0 0px 0px rgba(75,85,99,0)"]
                ...
                >
                  <div className="text-gray-300 text-2xl font-bold mb-1">Executive</div>
                  <div className="text-gray-500 text-sm">Dashboard & reporting</div>
                  <motion.div 
                    className="absolute inset-0 border border-gray-400/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                    animate={{ 
                      boxShadow: ["0 0 0px 0px rgba(75,85,99,0)", "0 0 10px 1px rgba(75,85,99,0.2)", "0 0 0px 0px rgba(75,85,99,0)"]
              ...
              <Link 
                ...
                className="inline-flex items-center text-gray-400 font-medium hover:text-gray-200 transition-colors group"
              >
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 border border-gray-700/30 rounded-xl overflow-hidden bg-gray-950">
                  
                  {/* Simulated terminal header */}
                  <div className="border-b border-gray-700/20 p-3 flex items-center justify-between bg-gray-900">
                    <div className="flex items-center space-x-2">
                      <div className="w-3 h-3 rounded-full bg-gray-600"></div>
                      <div className="w-3 h-3 rounded-full bg-gray-600"></div>
                      <div className="w-3 h-3 rounded-full bg-gray-600"></div>
                    </div>
                    <div className="text-xs text-gray-500">RETICULI TI (THREAT INTELLIGENCE)</div>
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center h-full text-center p-8">
                    ...
                    <div className="absolute inset-0 p-6 overflow-hidden">
                      ...
                      >
                        <motion.div
                          ...
                          className="text-gray-500 mb-2 text-sm font-mono"
                        >
                    ...
                    <div className="mb-6 p-4 bg-gray-800/10 rounded-full border border-gray-500/20">
                      <AlertTriangle className="w-16 h-16 text-gray-400" />
                    </div>
                    
                    <h3 className="text-xl font-bold text-gray-200 mb-2">Threat Intelligence Platform</h3>
                    <p className="text-gray-400 mb-6">Real-time security insights for defense contractors</p>
                    
                    <div className="flex space-x-4">
                      <Link 
                        to="/capabilities/tiaas" 
                        className="px-4 py-2 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-700 hover:to-gray-800 text-white rounded-md text-sm shadow-lg shadow-black/30 border border-gray-700/20 transition-colors duration-300"
                      >
                        Platform Details
                      </Link>
                      <Link 
                        to="/contact" 
                        className="px-4 py-2 bg-transparent border border-gray-700/30 hover:border-gray-500 text-gray-400 hover:bg-gray-900/20 hover:text-gray-200 rounded-md text-sm transition-all duration-300"
                      >
                        Request Demo
                      </Link>
                    </div>
                  ...
                  {/* Scanner animation */}
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-400/5 to-transparent h-20"
                    animate={{
                      top: ["0%", "100%", "0%"],
                    }}
                    transition={{
                  ...
                  <div className="absolute inset-0 overflow-hidden opacity-10">
                    <div className="absolute top-20 left-5 text-xs text-gray-500 font-mono">
                    ...
                    <div className="absolute bottom-20 right-5 text-xs text-gray-500 font-mono">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <motion.h2 
              ...
              transition={{ duration: 0.6 }}
            >
              Advanced <span className="text-gray-400">Research</span>
              <motion.span 
                className="absolute -bottom-2 left-0 w-full h-px bg-gradient-to-r from-transparent via-gray-500/50 to-transparent"
                initial={{ scaleX: 0, opacity: 0 }}
                whileInView={{ scaleX: 1, opacity: 1 }}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-100 mb-4">
                Defense <span className="text-gray-400">Partnerships</span>
              </h2>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-gray-100 mb-4 relative">
                  Defense <span className="text-gray-400">Contracting</span>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      <h5 className="font-medium text-gray-200">CMMC Compliance</h5>
                      <p className="text-gray-500 text-sm">Gap assessment and compliance assistance for defense contractors</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-3 mt-1 text-gray-400 bg-gray-900/30 p-1.5 rounded-md">
                    ...
                    <div>
                      <h5 className="font-medium text-gray-200">Targeted Prototypes</h5>
                      <p className="text-gray-500 text-sm">Solutions designed for specific defense requirements</p>
                    </div>
                  </li>
                </ul>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-gray-100 mb-4 relative">
                  Technology <span className="text-gray-400">Roadmap</span>
                  <span className="absolute -bottom-2 left-0 w-16 h-px bg-gray-500/40"></span>
                </h3>
                ...
                <ul className="space-y-3">
                  <li className="pb-3 border-b border-gray-700/20">
                    <div className="flex justify-between mb-1">
                      <span className="font-medium text-gray-200">OSINT Platform</span>
                      <span className="text-gray-400 text-sm">Q1-Q2 2025</span>
                    </div>
                    <p className="text-gray-500 text-sm">Initial release of our threat intelligence platform</p>
                  </li>
                  <li className="pb-3 border-b border-gray-700/20">
                    <div className="flex justify-between mb-1">
                      <span className="font-medium text-gray-200">Neuromorphic XDR</span>
                      <span className="text-gray-400 text-sm">Q3 2025</span>
                    </div>
                    <p className="text-gray-500 text-sm">Alpha release for partner testing</p>
                  </li>
                  <li>
                    <div className="flex justify-between mb-1">
                      <span className="font-medium text-gray-200">BlackLock Encryption</span>
                      <span className="text-gray-400 text-sm">Q4 2025</span>
                    </div>
                    <p className="text-gray-500 text-sm">Prototype validation with select partners</p>
                  </li>
                </ul>
                <Link 
                  to="/roadmap" 
                  className="mt-6 inline-flex items-center text-gray-400 hover:text-gray-200 text-sm font-medium transition-colors group"
                >
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        <span className="px-3 py-1 bg-gray-900/30 text-gray-300 text-xs font-medium rounded-full border border-gray-700/30">
          {emphasis}
        </span>
      </div>
...
const ResearchCard = ({ icon, title, description, status, linkTo }) => {
  return (
    <motion.div 
      className="bg-gradient-to-br from-gray-900 to-black border border-gray-700/20 p-6 rounded-lg h-full flex flex-col relative group"
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
      transition={{ duration: 0.6 }}
      whileHover={{ 
        translateY: -8,
        boxShadow: "0 10px 30px 0 rgba(0,0,0,0.3), 0 0 20px 0 rgba(75,85,99,0.1)",
      }}
    >
      <div className="absolute inset-0 bg-gradient-to-b from-gray-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg"></div>
      ...
      <div className="mb-4 flex justify-between items-start">
        <div className="p-2 bg-gray-900/20 text-gray-400 rounded-full border border-gray-700/30">
          {icon}
        </div>
        <span className="px-3 py-1 bg-gray-900/30 text-gray-300 text-xs font-medium rounded-full border border-gray-700/30">
          {status}
      ...
      <h3 className="text-xl font-bold text-gray-100 mb-3 group-hover:text-gray-50 transition-colors duration-300">{title}</h3>
      <p className="text-gray-500 mb-4 flex-grow group-hover:text-gray-400 transition-colors duration-300">{description}</p>
      
      <Link 
        to={linkTo} 
        className="text-gray-400 text-sm flex items-center hover:text-gray-200 transition-colors mt-auto group"
      >
        Learn more 
      ...
      <motion.div 
        className="absolute -top-2 -right-2 w-6 h-6 border-t-2 border-r-2 border-gray-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
        animate={{ 
          boxShadow: ["0 0 0px 0px rgba(75,85,99,0)", "0 0 5px 1px rgba(75,85,99,0.3)", "0 0 0px 0px rgba(75,85,99,0)"]
        }}
        transition={{ duration: 2, repeat: Infinity }}
