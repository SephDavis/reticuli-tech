...
const Home = () => {
  ...
  // Tech grid lines - styled like in About.js
  const TechGrid = () => (
  ...
  // Scan line animation - styled like in About.js
  const ScanLine = () => (
    <motion.div
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        {/* Decorative elements - like in About.js */}
        ...
        <div className="container mx-auto px-4 z-20 relative py-24">
          ...
          >
            ...
            <motion.h1 
              variants={itemVariants}
              className="text-5xl md:text-7xl font-bold text-gray-100 leading-tight mb-6"
              whileInView={{
            ...
            >
              Advanced defense technology solutions for emerging security challenges. As our website is still in development, information provided is subject to change.
            </motion.p>
        ...
        <div className="absolute bottom-10 left-10">
          ...
          >
            {[...Array(4)].map((_, i) => (
              <div 
                key={i} 
                className="w-3 h-3 rounded-full bg-gray-400/75"
              >
                <motion.div 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-gray-100 mb-6 relative inline-block">
                <span className="text-gray-400">Reticuli TI</span> OSINT Threat Intelligence
                <motion.span 
                  className="absolute -bottom-2 left-0 w-full h-px bg-gradient-to-r from-transparent via-gray-500/50 to-transparent"
                  initial={{ scaleX: 0, opacity: 0 }}
                  whileInView={{ scaleX: 1, opacity: 1 }}
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <motion.div 
                  className="bg-gradient-to-br from-gray-900 to-black border border-gray-700/20 p-5 rounded-lg group hover:bg-gray-800/90 transition-all duration-300"
                  whileHover={{ 
                    scale: 1.05,
                    boxShadow: "0 0 20px 0 rgba(75,85,99,0.3)"
                  }}
                >
                  <div className="text-gray-100 text-2xl font-bold mb-1">Multi-source</div>
                  <div className="text-gray-400 text-sm">Intelligence gathering</div>
                  <motion.div 
                    className="absolute inset-0 border border-gray-400/0 rounded-lg group-hover:border-gray-400/20 transition-opacity duration-500"
                    animate={{ 
                ...
                >
                  <div className="text-gray-100 text-2xl font-bold mb-1">Automated</div>
                ...
                >
                  <div className="text-gray-100 text-2xl font-bold mb-1">Custom</div>
                ...
                >
                  <div className="text-gray-100 text-2xl font-bold mb-1">Executive</div>
              ...
              <Link 
                ...
                className="inline-flex items-center text-gray-300 font-medium hover:text-white transition-colors group"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
              >
            ...
            >
              ...
              >
                <div className="absolute inset-0 border border-gray-700/10 rounded-xl overflow-hidden bg-gradient-to-br from-gray-900 to-black">
                  
                  <div className="border-b border-gray-700/30 p-3 flex items-center justify-between bg-gray-900/80">
                    <div className="flex items-center space-x-2">
                      <motion.div 
                        className="w-3 h-3 rounded-full bg-gray-400"
                        animate={{ backgroundColor: ["#4b5563", "#9ca3af", "#4b5563"] }}
                    ...
                    <div className="text-xs text-gray-400 uppercase tracking-wider">RETICULI TI (THREAT INTELLIGENCE)</div>
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center h-full text-center p-8">
                    <div className="absolute inset-0 p-6 overflow-hidden">
                      ...
                      >
                        <motion.div
                          ...
                          className="text-gray-400 mb-2 text-sm font-mono"
                        >
                        ...
                        <motion.div
                          ...
                          className="text-gray-100 mb-2 text-sm font-mono"
                        >
                          &gt; <motion.span 
                    ...
                    <motion.div 
                      className="mb-6 p-4 bg-gray-900/30 rounded-full border border-gray-600/30"
                      animate={{
                        boxShadow: ["0 0 0px rgba(255,255,255,0)", "0 0 15px rgba(75,85,99,0.3)", "0 0 0px rgba(255,255,255,0)"]
                      }}
                      transition={{ duration: 3, repeat: Infinity }}
                    >
                    ...
                    <h3 className="text-xl font-bold text-gray-100 mb-2">Threat Intelligence Platform</h3>
                    ...
                    <div className="flex space-x-4">
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                        <Link 
                          to="/capabilities/tiaas" 
                          className="px-4 py-2 bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-600 hover:to-gray-800 text-white rounded-md text-sm shadow-lg shadow-black/20 border border-gray-600/20 transition-colors duration-300"
                        >
                          Platform Details
                        </Link>
                      </motion.div>
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                        <Link 
                          to="/contact" 
                          className="px-4 py-2 bg-transparent border border-gray-700/30 hover:border-gray-500/60 hover:bg-gray-900/20 text-gray-300 hover:text-gray-100 rounded-md text-sm transition-all duration-300"
                        >
                          Request Demo
                        </Link>
                      </motion.div>
                  ...
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-400/10 to-transparent h-20"
                    animate={{
                      top: ["0%", "100%", "0%"],
                    }}
                    transition={{
                  ...
                  <div className="absolute inset-0 overflow-hidden opacity-20">
                    <div className="absolute top-20 left-5 text-xs text-gray-400 font-mono">
                    ...
                    <div className="absolute bottom-20 right-5 text-xs text-gray-400 font-mono">
              ...
              {/* Tech decorative elements - like in About.js */}
              <motion.div 
      ...
      <section className="py-20 bg-gray-950 relative overflow-hidden">
        ...
        {/* Moving tech elements background - styled like About.js */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-gray-100 mb-4 relative">
                  ...
                  <span className="absolute -bottom-2 left-0 w-16 h-px bg-gradient-to-r from-gray-500/50 to-transparent"></span>
                </h3>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="text-center p-10 border border-gray-700/20 rounded-xl bg-gradient-to-b from-gray-900/80 to-black/80 relative overflow-hidden shadow-2xl">
              {/* Tech decoration */}
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-gray-700/30 to-transparent"></div>
              <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-gray-700/30 to-transparent"></div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        <motion.span 
          className="px-3 py-1 bg-gray-900/20 text-gray-400 text-xs font-medium rounded-full border border-gray-700/30"
          animate={{
            boxShadow: ["0 0 0px rgba(255,255,255,0)", "0 0 5px rgba(75,85,99,0.2)", "0 0 0px rgba(255,255,255,0)"]
          }}
          transition={{ duration: 2, repeat: Infinity }}
        >
          {emphasis}
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex justify-between items-start">
        <motion.div 
          className="p-2 bg-gray-900/20 text-gray-400 rounded-full border border-gray-700/30"
      ...
      <h3 className="text-xl font-bold text-gray-100 mb-3 group-hover:text-white transition-colors duration-300">{title}</h3>
